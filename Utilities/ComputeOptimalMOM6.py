from OptimalArray.Utilities.MOM6Mat import InverseGOM,CovMOM6
...
data_file_handler = FilePathHandler(ROOT_DIR,'OptimalArrayMOM6')
...
class CovGOMOptimal(CovMOM6GOM):
	data_directory = os.path.join(get_data_folder(),'Processed/gom_optimal/')
