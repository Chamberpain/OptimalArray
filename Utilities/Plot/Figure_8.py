...
domain_counts, bins = np.histogram(domain_lats,bins=np.arange(-90,91,5))
domain_counts[domain_counts == 0] = 1
float_counts, bins = np.histogram(float_lats,bins=np.arange(-90,91,5))
ax2.hist(bins[:-1], bins, weights=float_counts/domain_counts,orientation="horizontal")
...
domain_counts, bins = np.histogram(domain_lons,bins=np.arange(-180,181,5))
domain_counts[domain_counts == 0] = 1
float_counts, bins = np.histogram(float_lons,bins=np.arange(-180,181,5))
ax3.hist(bins[:-1], bins, weights=float_counts/domain_counts)
