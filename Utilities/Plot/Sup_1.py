...
for depth in depth_list:
	...
	out_temp = np.split(cov_holder.cov.diagonal(),len(cov_holder.trans_geo.variable_list))
...
units_list = CovCM4Global.get_units(cov_holder)
...
plt.savefig(plot_handler.out_file('Sup_1'))