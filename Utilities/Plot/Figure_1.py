...
ax.scatter(X,Y,c=BGC.marker_color,s=BGC.marker_size,zorder=10,label='BGC Float')
Y,X = zip(*[(x.latitude,x.longitude) for x in core_locations])
ax.scatter(X,Y,c=Core.marker_color,s=Core.marker_size,zorder=9, label='Core Float')
